        ...
        <div className="Grid">
            ...
            <div className="Grid-left">
                <div className="Grid-inside">
                    {/*  Description  */}
                    <h1> API Reference </h1>
                    <p>The Gorgias API is organized around REST. Our API has predictable, resource-oriented
                        ...
                        appropriate language-specific objects.</p>
                    <p>To make the API as explorable as possible, accounts have test mode and live mode API
