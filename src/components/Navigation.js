...
const Navigation = ({location}) => {
    ...
    return (
        <div className="navigation">
            ...
            <ul className="nav-menu">
                {
                    orderedResources.map(tag => (
                        <li key={tag.get('name')}>
                            <NavLink activeClassName="active" to={`/api/${tag.get('name')}`}>
                                {tag.get('name')}
                            </NavLink>
                            {
            ...
            <strong className="h-small light">Object definitions</strong>
            <ul className="nav-menu">
                {
