    ...
    <div id="errors" className="section">
        <div className="wrap">
            ...
            <div className="column left">
                ...
                <p>
                    Either the endpoint you sent a request to, or an object reference in the path (like the <Code light
                                                                                                                  inline>user_id
                    = 0</Code> in <Code light inline>/api/users/0/</Code>) references an object which doesn&#39;t exist.
                </p>
                ...
                <p>
                    You tried using a method which is not allowed (like a <Code light inline>POST</Code> on a <Code
                    light inline>detail</Code> endpoint).
                </p>
