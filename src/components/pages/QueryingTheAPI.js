    ...
    <div id="querying-the-api" className="section">
        <div className="wrap">
            ...
            <div className="column left">
                ...
                <p>
                    When sending data in the body, you must send it as <Code light inline>JSON</Code> (with the header
                    <Code light inline>Content-type</Code> set at <Code light inline>application/json</Code>). For now
                    (and it probably won't change), we don't accept <Code light inline>text/xml</Code> nor <Code light
                                                                                                                 inline>multipart/form-data</Code>
                    content types.
                </p>
                ...
                <p>
                    If you work with nested object you should be extra careful. If you just want to reference an object
                    (a user for example), only include its id like so:
                </p>
                ...
                <p>
                    If you include any other field, it will <strong>update the object</strong>. You can do it; however,
                    don&#39;t do it by mistake: it may erase previous modifications made by other users, other scripts,
                    or the rules of your account.
                </p>
